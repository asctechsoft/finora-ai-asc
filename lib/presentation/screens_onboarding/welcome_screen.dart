  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Image.asset('assets/images/png/img_wellcome.png', height: 240),
          ...
          child: Row(
            ...
            children: [
              _Benefit(
                ...
                title: 'benefit_talk'.tr,
                sub: 'benefit_talk_sub'.tr,
              ),
              _Benefit(
                icon: Icons.bar_chart_rounded,
                title: 'benefit_track'.tr,
                sub: 'benefit_track_sub'.tr,
              ),
              _Benefit(
                icon: Icons.track_changes_rounded,
                title: 'benefit_plan'.tr,
                sub: 'benefit_plan_sub'.tr,
              ),
            ],
          ),
        ),
